...
export const PlayerInitError: React.FC<PlayerInitErrorProps> = ({
  ...
  const isRuntimeError = !isWebRuntime && looksLikeRuntimeError(error);
  ...
  return (
    <div className="player-page controls-visible">
      <div className="player-error">
        <h2>{isWebRuntime ? "Browser player could not play this stream" : "Native player could not start"}</h2>
        ...
        <div className="player-error-actions">
          {!isWebRuntime && onOpenVlc && <button onClick={onOpenVlc}>Open in VLC</button>}
