...
export const EpisodeDetailsDialog: React.FC<EpisodeDetailsDialogProps> = (props) => {
  if (!props.details) return null;
  return <OpenEpisodeDetailsDialog details={props.details} onClose={props.onClose} />;
};

type OpenEpisodeDetailsDialogProps = Omit<EpisodeDetailsDialogProps, "details"> & {
  details: EpisodeDetails;
};

const OpenEpisodeDetailsDialog: React.FC<OpenEpisodeDetailsDialogProps> = ({
  details,
  onClose,
}) => {
