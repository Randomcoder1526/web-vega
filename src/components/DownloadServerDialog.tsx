...
export const DownloadServerDialog: React.FC<DownloadServerDialogProps> = (props) => {
  if (!props.isOpen) return null;
  return <OpenDownloadServerDialog {...props} />;
};

const OpenDownloadServerDialog: React.FC<DownloadServerDialogProps> = ({
  isOpen,
  onClose,
  streams,
  episodeTitle,
