...
export default function App() {
  ...
  // Preserve the browser console so provider diagnostics are not lost.

  useEffect(() => {
    // Shared-folder sync is a native desktop feature. Running it in a normal
    // browser only creates no-op work and misleading console warnings.
    if (!isTauriRuntime()) return;
